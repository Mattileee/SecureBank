  ...
  return (
    <Layout>
      <div className="space-y-6">
        {/* Header with Request Statement button */}
        <div className="flex justify-between items-center">
          ...
          {/* Request Statement button styled as link */}
          <a
            href="#"
            className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded cursor-pointer"
            onClick={(e) => { e.preventDefault(); /* Implement request logic here */ }}
          >
          ...
          <div className="space-y-3">
            {filteredStatements.map((statement) => (
              <div key={statement.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                {/* View and Download buttons styled as links */}
                <div className="flex space-x-2">
                  <a
                    href="#"
                    className="flex items-center space-x-1 text-blue-600 hover:underline"
                    onClick={(e) => { e.preventDefault(); /* View logic here */ }}
                  >
                  ...
                  <a
                    ...
                    onClick={(e) => { e.preventDefault(); /* Download logic here */ }}
                  >
        ...
        <Card className="p-6 bg-blue-50 border-blue-200">
          ...
          {/* Enable and Learn More buttons styled as links */}
          <div className="flex space-x-3">
            <a
              href="#"
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded cursor-pointer"
              onClick={(e) => { e.preventDefault(); /* Enable eStatements */ }}
            >
              Enable eStatements
            </a>
            <a
              href="#"
              className="border border-blue-300 text-blue-700 hover:bg-blue-100 px-4 py-2 rounded cursor-pointer"
              onClick={(e) => { e.preventDefault(); /* Learn more */ }}
            >
              Learn More
            </a>
          </div>
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Manage Settings button styled as link */}
            <div>
              <h3 className="font-medium text-gray-900 mb-4">Update Preferences</h3>
              <a
                href="#"
                className="block w-full bg-gray-600 text-white px-4 py-2 rounded cursor-pointer"
                onClick={(e) => { e.preventDefault(); /* Manage delivery settings */ }}
              >
