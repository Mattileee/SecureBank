  ...
  return (
    <Layout>
      <div className="space-y-6">
        {/* Header with Show/Hide and Request Card buttons */}
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); setShowCardNumbers(!showCardNumbers); }}
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/request-card'); }}
              className="flex items-center space-x-2 bg-gray-200 px-3 py-2 rounded hover:bg-gray-300 cursor-pointer"
            >
            ...
            <div key={card.id} className="space-y-4">
              ...
              <Card className="p-4">
                <div className="space-y-3">
                  ...
                  {/* Block/Unblock and Settings buttons */}
                  <div className="pt-3 border-t flex space-x-2">
                    <a
                      href="#"
                      onClick={(e) => { e.preventDefault(); navigate(`/cards/${card.id}/block`); }}
                      className="flex-1 inline-flex items-center justify-center px-2 py-1 border border-gray-300 rounded hover:bg-gray-100"
                    >
                      {card.status === 'active' ? (
                        <>
                    ...
                    <a
                      href="#"
                      onClick={(e) => { e.preventDefault(); navigate(`/cards/${card.id}/settings`); }}
                      className="flex-1 inline-flex items-center justify-center px-2 py-1 border border-gray-300 rounded hover:bg-gray-100"
                    >
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/card/freeze'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/card/limits'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/card/replace'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/card/add'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
