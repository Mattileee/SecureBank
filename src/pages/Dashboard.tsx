      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6">
            ...
            {/* View All Transactions link styled as a button */}
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/transactions'); }}
              className="block w-full mt-4 bg-gray-200 text-center py-2 rounded cursor-pointer hover:bg-gray-300"
            >
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/pay-bills'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
            ...
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); navigate('/deposit'); }}
              className="h-20 flex-col flex items-center justify-center border border-gray-300 rounded-lg text-center text-lg font-bold cursor-pointer hover:bg-gray-100"
            >
